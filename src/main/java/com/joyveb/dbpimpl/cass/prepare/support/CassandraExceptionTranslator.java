 ...
 */
package com.joyveb.dbpimpl.cass.prepare.support;

import com.joyveb.dbpimpl.cass.prepare.support.exception.CassandraAuthenticationException;
import com.joyveb.dbpimpl.cass.prepare.support.exception.CassandraConnectionFailureException;
import com.joyveb.dbpimpl.cass.prepare.support.exception.CassandraInsufficientReplicasAvailableException;
import com.joyveb.dbpimpl.cass.prepare.support.exception.CassandraInternalException;
import com.joyveb.dbpimpl.cass.prepare.support.exception.CassandraKeyspaceExistsException;
import com.joyveb.dbpimpl.cass.prepare.support.exception.CassandraTableExistsException;
import com.joyveb.dbpimpl.cass.prepare.support.exception.CassandraTruncateException;
import com.joyveb.dbpimpl.cass.prepare.support.exception.CassandraUnauthorizedException;
import com.joyveb.dbpimpl.cass.prepare.support.exception.CassandraUncategorizedException;
import com.joyveb.dbpimpl.cass.prepare.support.exception.CassandraWriteTimeoutException;
